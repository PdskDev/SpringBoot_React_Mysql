...
public class CardatabaseApplication implements CommandLineRunner {
	...
	public void run (String... args) throws Exception {
		...
		repository.save(new Car("Toyota", "Prius", "Silver", "KKO-0212", 2020, 39000, owner1));
		repository.save(new Car("Peugeot", "508", "Black", "GGO-0520", 2021, 55000, owner2));
		repository.save(new Car("Renault", "Talisman", "Green", "PAR-1550", 2021, 65000, owner1));
